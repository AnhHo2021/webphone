...
webphone_api.parameters = {
	serveraddress: '1Wire',  //SET to your SIP server IP address, domain name or SRV DNS record (also set the :port if that is not the default 5060). Example: sip.myserveraddress.com:5070
	proxyaddress: 'core1-slc.1wire.co:5060',   //Optional SIP proxy address. Specify only if you must use an outbound SIP proxy which is different from the above serveraddress. 
	//webrtcserveraddress: 'wss://core1-slc.1wire.co:9002', //Optional websocket server URL if your VoIP server has WebRTC support. Example: wss://domain:8089/ws
	...
	colortheme: 22,
	incomingcallpopup: 3,
	callnot_title: '1CX Pro Call',
	callnot_image: 'https://phone.1cxpro.com/admin/public/assets/img1/drawer_default.png',
	//enginepriority_webrtc: 3,
	//enginepriority_ns: 1,
	showtoasts: true,
	//callreceiver: 2
